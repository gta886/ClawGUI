...
- [快速开始](#-快速开始)
  ...
  - [ClawGUI-APP — 真机部署](#-clawgui-app--真机部署)
- [路线图](#️-路线图)
- [致谢](#-致谢)
- [许可证](#-许可证)
...
| 📱 **[ClawGUI-APP](clawgui-app/)** | **真机部署** — 在一台 Android 手机上直接运行完整的 Brain + GUI Agent，无需桌面端协调，基于 Shizuku 实现 |
...
> 📁 [`clawgui-app/`](clawgui-app/) · 📖 [完整文档](clawgui-app/README.md) · [中文安装指南](clawgui-app/SETUP.md) · [English Setup](clawgui-app/SETUP_EN.md)
...
→ **[查看 ClawGUI-APP 完整文档](clawgui-app/README.md)**
...
- [x] **真机部署 ClawGUI-Agent（[ClawGUI-APP](clawgui-app/)）** — 将 ClawGUI-Agent 直接部署在真实手机上，避免云端泄露隐私
